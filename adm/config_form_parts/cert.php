        ...
        <div class="af-grid">
            ...
            <div class="af-row cf_cert_service">
                ...
                <div class="af-field">
                    ...
                    <label for="cf_cert_find" class="af-check form-label">
                        <input type="checkbox" name="cf_cert_find" id="cf_cert_find" value="1"<?php echo $config_cert_view['cf_cert_find_checked']; ?> class="form-checkbox">
            ...
            <div class="af-row cf_cert_service">
                ...
                <div class="af-field">
                    <div class="af-inline">
                        <span>SRA</span>
                        <input type="text" name="cf_cert_kg_mid" value="<?php echo $config_cert_view['cf_cert_kg_mid']; ?>" id="cf_cert_kg_mid" size="10" minlength="7" maxlength="7" class="form-input">
                    </div>
            ...
            <div class="af-row cf_cert_service">
                ...
                <div class="af-field">
                    <input type="text" name="cf_cert_kg_cd" value="<?php echo $config_cert_view['cf_cert_kg_cd']; ?>" id="cf_cert_kg_cd" size="40" minlength="32" maxlength="32" class="form-input">
                </div>
            </div>
            ...
            <div class="af-row cf_cert_service">
                ...
                <div class="af-field">
                    ...
                    <div class="af-inline">
                        <span>SM</span>
                        <input type="text" name="cf_cert_kcp_cd" value="<?php echo $config_cert_view['cf_cert_kcp_cd']; ?>" id="cf_cert_kcp_cd" size="3" class="form-input">
                    </div>
            ...
            <div class="af-row cf_cert_service">
                ...
                <div class="af-field">
                    ...
                    <div class="af-inline">
                        <input type="text" name="cf_cert_kcp_enckey" value="<?php echo $config_cert_view['cf_cert_kcp_enckey']; ?>" id="cf_cert_kcp_enckey" maxlength="100" size="40" class="form-input">
            ...
            <div class="af-row cf_cert_service">
                ...
                <div class="af-field">
                    ...
                    <div class="af-inline">
                        <input type="text" name="cf_cert_limit" value="<?php echo $config_cert_view['cf_cert_limit']; ?>" id="cf_cert_limit" size="3" class="form-input">
                        <span>회</span>
                    </div>
                </div>
            </div>
            ...
            <div class="af-row cf_cert_service">
                ...
                <div class="af-field">
                    ...
                    <label for="cf_cert_req" class="af-check form-label">
                        <input type="checkbox" name="cf_cert_req" value="1" id="cf_cert_req" <?php echo $config_cert_view['cf_cert_req_checked']; ?> class="form-checkbox">
...
<?php echo $config_cert_view['cert_module_check_html']; ?>
