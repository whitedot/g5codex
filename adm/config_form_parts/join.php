        ...
        <div class="af-grid">
                ...
                <div class="af-field">
                    <div class="af-inline">
                        <label for="cf_use_hp" class="af-check form-label">
                            <input type="checkbox" name="cf_use_hp" value="1" id="cf_use_hp"<?php echo $config_join_view['cf_use_hp_checked']; ?> class="form-checkbox">
                            <span class="form-label">보이기</span>
                        </label>
                        <label for="cf_req_hp" class="af-check form-label">
                            <input type="checkbox" name="cf_req_hp" value="1" id="cf_req_hp"<?php echo $config_join_view['cf_req_hp_checked']; ?> class="form-checkbox">
            ...
            <div class="af-row">
                ...
                <div class="af-field">
                    ...
                    <textarea name="cf_prohibit_id" id="cf_prohibit_id" rows="5" class="form-textarea"><?php echo $config_join_view['cf_prohibit_id']; ?></textarea>
                </div>
            </div>
            ...
            <div class="af-row">
                ...
                <div class="af-field">
                    ...
                    <textarea name="cf_prohibit_email" id="cf_prohibit_email" rows="5" class="form-textarea"><?php echo $config_join_view['cf_prohibit_email']; ?></textarea>
                </div>
            </div>
            ...
            <div class="af-row">
                ...
                <div class="af-field">
                    <textarea name="cf_stipulation" id="cf_stipulation" rows="10" class="form-textarea"><?php echo $config_join_view['cf_stipulation']; ?></textarea>
                </div>
            </div>
            ...
            <div class="af-row">
                ...
                <div class="af-field">
                    <textarea id="cf_privacy" name="cf_privacy" rows="10" class="form-textarea"><?php echo $config_join_view['cf_privacy']; ?></textarea>
                </div>
            </div>
            ...
            <div class="af-row">
                ...
                <div class="af-field">
                    ...
                    <label for="cf_use_promotion" class="af-check form-label">
                        <input type="checkbox" name="cf_use_promotion" value="1" id="cf_use_promotion"<?php echo $config_join_view['cf_use_promotion_checked']; ?> class="form-checkbox">
