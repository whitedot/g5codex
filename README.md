...
G5 Member Runtime은 그누보드5 계열 런타임을 회원 중심 애플리케이션으로 정리하고, 커뮤니티 기능을 현재 프로젝트 구조에 맞춰 복구한 PHP 애플리케이션이다.
...
- 커뮤니티 기능은 단순 복원이 아니라 단일 테이블 세트, 최신글 인덱스, 포인트 원장, 알림 로그를 갖춘 운영형 구조로 제공한다.
...
13. 최신글과 스크랩
14. 커뮤니티 알림 로그
15. 커뮤니티 포인트 지급, 차감, 만료 정산
16. `adm/community_health.php` 테이블 상태 확인
