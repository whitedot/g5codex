...
?>
<div>
    <h1><?php echo get_text($board['name']); ?> 새 게시글 알림</h1>
    <p><strong><?php echo get_text($post['title']); ?></strong> 글이 등록되었습니다.</p>
    <p><?php echo nl2br(get_text(cut_str($post['content'], 300))); ?></p>
